...
from core.openai_translator import OpenAITranslator, TranslationError
...
def get_translator(
    ...
    return OpenAITranslator(api_key=api_key, model=model, timeout=timeout)
